...
public class ShortestCompletingWord {
    ...
    Printer.printCorrectAnswer(
        ...
        new Solution()
            .shortestCompletingWord(
                "1s3 PSt", DataBuilder.buildStringArray("step", "steps", "stripe", "stepple")));
    Printer.printCorrectAnswer(
        "pest",
        new Solution()
            .shortestCompletingWord(
                "1s3 456", DataBuilder.buildStringArray("looks", "pest", "stew", "show")));
    Printer.printCorrectAnswer(
        "husband",
        new Solution()
            .shortestCompletingWord(
  ...
  static class Solution {
    /**
     * 执行用时： 14 ms , 在所有 Java 提交中击败了 17.68% 的用户
     *
     * <p>内存消耗： 39.2 MB , 在所有 Java 提交中击败了 15.20% 的用户
     *
     * @param licensePlate
     * @param words
     * @return
    ...
    public String shortestCompletingWord(String licensePlate, String[] words) {
      Map<Character, Integer> map = getCharacterMap(licensePlate);
      String result = null;
      for (String word : words) {
        Map<Character, Integer> m = getCharacterMap(word);
        boolean flag = true;
    ...
    private Map<Character, Integer> getCharacterMap(String licensePlate) {
